(() => {
  ...
  async function loadUsers() {
    ...
    try {
      ...
      return snapshot.docs.map((doc) => ({ id: doc.id, ...doc.data() })).sort((a, b) => String(a.username || a.displayName || a.email || a.id).localeCompare(String(b.username || b.displayName || b.email || b.id), undefined, { sensitivity: 'base', numeric: true }));
    } catch { return []; }
  }
  ...
  async function render(target, user, profile, toast) {
    ...
    bind(target, user, profile, toast, users); return true;
  }
